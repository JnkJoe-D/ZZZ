...
namespace Game.Editor.BehaviorTree
{
    public class TreeGraphViewr : GraphView
    {
        ...
        public System.Action onGraphModified;
        public TreeGraphViewr()
        {
            ...
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/GraphTools/NodeEditor/TreeGraphViewr.uss");
            if (styleSheet != null)
            {
        ...
        private void CreateNodeView(NodeData node)
        {
        ...
        private TreeNodeView FindNodeViewByGuid(NodeData node)
        {
        ...
        public void UpdateNodeStates(BTRunner runner)
        {
            nodes.ForEach(n => {
