...
namespace Game.GamePlay
{
    ...
    public class HitPipeline
    {
        ...
        public static HitPipeline CreateDefaultPipeline()
        {
            ...
            pipeline.RegisterPipe(new ProtectionPipe());
            pipeline.RegisterPipe(new ParryPipe());
            pipeline.RegisterPipe(new DamageCalculationPipe());
            pipeline.RegisterPipe(new ResilienceAndStaggerPipe());
            pipeline.RegisterPipe(new MotionAndActionPipe());
            pipeline.RegisterPipe(new FeedbackPresentationPipe());
            return pipeline;
        }
    }
}
