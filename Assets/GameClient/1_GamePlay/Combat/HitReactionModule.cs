...
namespace Game.GamePlay
{
    ...
    public abstract class HitReactionModule : MonoBehaviour
    {
        ...
        {
            if (_entity.StatusModule != null && _entity.StatusModule.Attributes != null && _entity.StatusModule.Attributes.Has(Game.GamePlay.AttributeId.BaseResilience))
            {
                float currentRes = _entity.StatusModule.Attributes.GetCurrent(Game.GamePlay.AttributeId.BaseResilience);
        ...
        private void PlayHitAudio(HitContext ctx)
        {
            ...
            if (AudioManager.Instance != null)
            {
                ...
                var args = new Game.Framework.AudioArgs
                {
                    position = soundPos,
                    spatialBlend = 1f,
                    volume = 1f,
