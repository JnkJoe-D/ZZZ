...
namespace Game.GamePlay
{
    ...
    public class AttributeSet
    {
        ...
        private void PublishChange(AttributeId id, float oldValue, float newValue)
        {
            ...
            EventCenter.Publish(new PlayerStatChangedEvent
            {
        ...
        private static StatType MapToStatType(AttributeId id)
        {
            return id switch
            {
                AttributeId.HP => StatType.HP,
                AttributeId.Energy => StatType.MP,
                AttributeId.Decibel => StatType.Stamina,
                _ => StatType.Experience // fallback
            };
        }
    }
}
