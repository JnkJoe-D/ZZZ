...
namespace Game.GamePlay
{
    public class RoleStatusDataProvider : IStatusDataProvider
    {
        ...
        public IEnumerable<AttributeInstance> GetInitialAttributes(int level)
        {
            ...
            {
                GLog.Warning(LogTags.Combat, $"找不到角色 {_characterId} 的基础配置 (TbCharacterBase)！使用保底数据。");
            ...
            {
                GLog.Warning(LogTags.Combat, $"找不到角色 {_characterId} 的能量配置 (TbCharacterEnergy)！使用保底数据。");
