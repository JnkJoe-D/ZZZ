...
namespace ATEditor
{
    ...
    /// </summary>
    public interface IHitHandler : IService
    {
        void OnHitDetect(HitData hitData);

        /// <summary>
        /// 允许上层战斗系统根据特定的战斗机制（如拼刀契约）追加命中目标
        /// </summary>
        void AppendExtraHitTargets(GameObject deployer, System.Collections.Generic.List<Collider> outHits) { }
    }
