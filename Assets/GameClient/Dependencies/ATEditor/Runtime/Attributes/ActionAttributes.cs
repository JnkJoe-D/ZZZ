...
namespace ATEditor
{
    ...
    public class ActionPropertyAttribute : Attribute
    {
        ...
        public ActionPropertyAttribute(string name)
        {
            Name = name;
        }
    }
    ...
    public class ActionAssetReferenceAttribute : Attribute
    {
        public string TargetFieldName { get; private set; }

        public ActionAssetReferenceAttribute(string targetFieldName)
        {
            TargetFieldName = targetFieldName;
        }
    }
    [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
    public class ATShowIfAttribute : Attribute
    {
        public string conditionalSourceField;
        public object expectedValue;
        public bool isEqual;
        public ATShowIfAttribute(string conditionalSourceField, object expectedValue,bool isEqual = true)
        {
