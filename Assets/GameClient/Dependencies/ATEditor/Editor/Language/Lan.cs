...
namespace ATEditor.Editor
{
    public static class Lan
    {
        ...
        // 窗口启用 (OnEnable) 时调用的语言加载方法
        public static void Load()
        {
            AllLanguages.Clear();
            
            // 查找所有 ILanguages 接口的实现
        ...
        // ================== 本地化字段 ==================
        // 以下字段会在 RefreshLanguage() 调用时被覆盖更新
        ...
        // Warning
        public static string PreviewTargetWarning = "Please set a preview target to enable timeline seeking.";
    }
}
