...
namespace Game.Framework
{
    ...
    public class NetworkManager : Game.Framework.Singleton<NetworkManager>
    {
        ...
        public void Initialize(string host, int tcpPort, int udpPort)
        {
            ...
            GLog.Info(LogTags.Network, $"初始化完成 -> {host}:{tcpPort} (TCP), {udpPort} (UDP)");
        }
        ...
        public void ConnectTcp()
        {
            ...
            {
                GLog.Warning(LogTags.Network, $"TCP 连接尝试失败: {e.Message}");
        ...
        private void OnReconnectSuccess()
        {
            ...
            if (!string.IsNullOrEmpty(_token))
            {
                ...
                GLog.Info(LogTags.Network, "已发送重连请求");
            }
        }
        ...
        private void OnServerError(CommonResponse response)
        {
            ...
            GLog.Warning(LogTags.Network, $"服务端错误: [{response.Code}] {response.Message}");
        }
