...
namespace Game.Framework
{
    public class GameCameraManager : Game.Framework.Singleton<GameCameraManager>
    {
        ...
        public void Initialize()
        {
            ...
            if (MainCamera == null)
            {
                GLog.Warning(LogTags.Camera, "MainCamera was not found in the scene.");
            }

            GLog.Info(LogTags.Camera, "Initialized.");
        }
        ...
        public void Shutdown()
        {
            ...
            GLog.Info(LogTags.Camera, "Shutdown.");
        }
        ...
        public void SetTarget(Transform target)
        {
            ...
            if (target != null)
            {
                GLog.Info(LogTags.Camera, $"Camera target set to: {target.name}");
            }
        }
        ...
        {
            GLog.Info(LogTags.Camera, $"Camera shake impulse: {impulseVelocity}");
        }
        ...
        public async Task<GameObject> LoadCameraAsync(string path)
        {
            ...
            GameObject cam = await Game.Framework.ResourceManager.Instance.LoadAssetAsync<GameObject>(path);
            return cam;
        }
    }
}
