...
namespace ATEditor.Editor
{
    ...
    public class ATEditorState
    {
        ...
        public bool isStopped = true;    // 是否处于停止状态（彀0 且隐藏指示器＀
        ...
        public GameObject initialAutoPreviewTarget; // 记录打开时自动创建或寻找的默认目栀
        ...
        public bool isTimelineSelected = false; // 是否选中了整一Timeline 对象
        ...
        public Group copiedGroup;       // 复制的分绀
        ...
        /// <summary>
        /// 计算整个 Timeline 的总显示高度（遍历 groups 鈫?tracks锛?
        /// </summary>
        ...
        /// <summary>
        /// 根据片段查找所属轨道（遍历 groups 鈫?tracks锛?
        /// </summary>
