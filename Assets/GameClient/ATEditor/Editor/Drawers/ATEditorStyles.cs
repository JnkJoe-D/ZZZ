...
namespace ATEditor.Editor
{
    ...
    /// 若需美化界面或调整尺寸，请统一修改此处　
    /// </summary>
    public static class ATEditorStyles
    {
        // ==================== 尺寸与布局常量 ====================
        
        /// <summary> 时间标尺区域的高庀</summary>
        ...
        /// <summary> 左侧轨道列表区域的总宽庀</summary>
        public const float TRACK_LIST_WIDTH = 200f;
        
        /// <summary> 右侧时间轴内片段区块的高庀</summary>
