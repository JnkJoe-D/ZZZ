...
namespace Game.UI
{
    ...
    public class SkillKeyView : UIView
    {
        ...
        [SerializeField] private BlockEnergyWithShader _switchEnergyWidget;
        ...
        private void EnsureBindings()
        {
            ...
            if (keysRoot == null)
            {
                Debug.LogWarning("[SkillKeyView] 未找到 'View/Keys' 节点");
                return;
            }
            ...
            if (_switchEnergyWidget == null) _switchEnergyWidget = keysRoot.Find("KeySwitch/Icons/IconKey")?.GetComponent<BlockEnergyWithShader>();
